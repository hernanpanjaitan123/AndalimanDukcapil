                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-sitemap"></i> Layanan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a> Permohonan Akta Kelahiran<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=akta_kelahiran"> Permohonan</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kelahiran_disetujui"> Disetujui</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kelahiran_ditolak"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                        <li><a> Permohonan Kartu Keluarga<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=kartu_keluarga"> Permohonan</a>
                            </li>
                            <li><a href="index.php?halaman=kartu_keluarga_disetujui"> Disetujui</a>
                            </li>
                            <li><a href="index.php?halaman=kartu_keluarga_ditolak"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                        <li><a> Permohonan Akta Perkawinan<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=akta_kawin"> Permohonan</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kawin_disetujui"> Disetujui</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kawin_diolak"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                        <li><a> Permohonan Akta Perceraian<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=akta_perceraian"> Permohonan</a>
                            </li>
                            <li><a href="index.php?halaman=akta_perceraian_disetujui"> Disetujui</a>
                            </li>
                            <li><a href="index.php?halaman=akta_perceraian_ditolak"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                        <li><a> Permohonan Akta Kematian<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=akta_kematian"> Permohonan</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kematian_disetujui"> Disetujui</a>
                            </li>
                            <li><a href="index.php?halaman=akta_kematian_ditolak"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                        <li><a> Permohonan Pindah Datang<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <a href="index.php?halaman=kedatangan"> Permohonan</a>
                            </li>
                            <li><a href="#level2_1"> Disetujui</a>
                            </li>
                            <li><a href="#level2_2"> Ditolak</a>
                            </li>
                          </ul>
                        </li>
                    </ul>

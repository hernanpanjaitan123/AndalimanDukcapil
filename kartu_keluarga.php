       ...
       echo '<form action="proses_kartu_keluarga.php?id_penduduk='.$_SESSION['id_penduduk'].'" method="post" enctype="multipart/form-data">'; 
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              <label>Formulir isian Biodata Penduduk</label>
              <input type="file" name="fc_akta_nikahzzz" class="form-control"/>
              <div class="validation"></div>
            </div>
          </div>
          <div class="form-row">
          <div class="form-group col-md-6">
              <label>Akta Kelahiran/ Surat Kelahiran</label>
              <input type="file" name="fc_akta_kelahiran" class="form-control" required/>
              <div class="validation"></div>
            </div>
            <div class="form-group col-md-6">
              <label>Akta Kawin/Buku Nikah</label>
